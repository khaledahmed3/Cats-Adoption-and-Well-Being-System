        ...
        <header class="header_section">
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="healthcare.php">
                        <span>
                            Cat Healthcare
                        </span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                            <li class="nav-item active">
                                <a class="nav-link" href="service-provider.php">Provider <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="owner-list-SV.php">Owner List</a>
                            </li>
                            <li class="nav-item active">
                                <a class="nav-link" href="index1.php">Add Cats</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                    ...
                    <div class="footer_contact">
                        ...
                        <div class="contact_link_box">
                            <a href="">
                                ...
                                <span>
                                    Location: Danga Bay, Country Garden, Bay Larul
                                </span>
                            </a>
                            <a href="">
                ...
                <div class="col-md-6 col-lg-2 mx-auto footer_col">
                    <div class="footer_link_box">
                        ...
                        <div class="footer_links">
                            <a class="active" href="service-provider.php">
                                Provider
                            </a>
                            <a class="" href="owner-list-SV.php">
                                Owner List
                            </a>
